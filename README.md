# Self-Tracing
## Building on Anthropic's [Neuronpedia](https://github.com/safety-research/circuit-tracer) Circuit Tracing methodology (Lindsey et al., 2025), we extend the paradigm to enable recursive self-interpretation, where models continuously monitor, trace, and explain their own decision processes. 
